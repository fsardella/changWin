        ...
        <div class="container">
            ...
            <section class="row">
                <div id="show-problema" class="col-12 content scaffold-show" role="main">
                    ...
                    <g:form resource="${this.problema}" method="DELETE">
                        <fieldset class="buttons">
                            <g:link class="edit" action="edit" resource="${this.problema}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
