        ...
        <div class="container">
            ...
            <section class="row">
                <div id="show-cotizacion" class="col-12 content scaffold-show" role="main">
                    ...
                    <g:form resource="${this.cotizacion}" method="DELETE">
                        <fieldset class="buttons">
                            <g:link class="edit" action="edit" resource="${this.cotizacion}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
