        ...
        <div class="container">
            ...
            <section class="row">
                <div id="show-certificado" class="col-12 content scaffold-show" role="main">
                    ...
                    <f:display bean="certificado" />
                    <g:form resource="${this.certificado}" method="DELETE">
                        <fieldset class="buttons">
                            <g:link class="edit" action="edit" resource="${this.certificado}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
